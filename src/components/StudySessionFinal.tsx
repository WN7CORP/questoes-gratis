...
const StudySessionFinal = ({
  ...
  return <div className="h-full flex flex-col">
      ...
      <div className="bg-netflix-card border-b border-netflix-border p-4 flex items-center justify-between py-[10px]">
        ...
        <Button onClick={finishSession} variant="outline" className="border-netflix-red text-netflix-red hover:bg-netflix-red hover:text-white py-0 my-0 mx-0 px-[3px]">
      ...
      <ScrollArea className="flex-1" ref={scrollAreaRef}>
        <div className="max-w-6xl mx-auto p-4 px-[6px]">
          ...
          <div className="flex justify-between items-center mb-20">
            <Button onClick={goToPreviousQuestion} disabled={currentQuestionIndex === 0} variant="outline" className="w-24 sm:w-32">
              <ArrowLeft className="mr-2 h-4 w-4" />
              Anterior
            </Button>

            <Button onClick={goToNextQuestion} disabled={isLastQuestion} variant="outline" className="w-24 sm:w-32">
              Próxima
      ...
      {isCurrentQuestionAnswered() && <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-40">
          <Button onClick={handleShowJustification} disabled={usageLoading} className={`${getCommentButtonStyle()} px-6 py-3 rounded-full shadow-lg transition-all duration-200 hover:scale-[1.02] flex items-center gap-2`}>
