...
const StudySessionFinal = ({
  ...
  if (questions.length === 0) {
    return <div className="flex flex-col items-center justify-center h-full text-center p-6 bg-gray-900">
  ...
  return <div className="h-full flex flex-col bg-gray-900">
      ...
      <div className="bg-gray-800 border-b border-gray-700 p-3 sm:p-4 flex items-center justify-between shadow-lg">
        <Button onClick={onExit} variant="ghost" size="sm" className="text-white hover:text-blue-400 hover:bg-gray-700 transition-all duration-200">
        ...
        <Button onClick={finishSession} variant="outline" size="sm" className="border-blue-600 text-blue-400 hover:bg-blue-600 hover:text-white transition-all duration-200">
      ...
      <ScrollArea className="flex-1" ref={scrollAreaRef}>
        <div className="max-w-6xl mx-auto p-3 sm:p-6 px-[7px]">
          {/* Progress Bar */}
          ...
          <div className="flex justify-between items-center mb-16 sm:mb-24">
            <Button onClick={goToPreviousQuestion} disabled={currentQuestionIndex === 0} variant="outline" size="sm" className="w-24 sm:w-32 h-10 sm:h-12 text-sm sm:text-base font-medium hover:scale-105 transition-transform duration-200 border-gray-600 text-gray-300 hover:bg-gray-700">
              <ArrowLeft className="mr-1 sm:mr-2 h-4 w-4" />
              Anterior
            </Button>

            <Button onClick={goToNextQuestion} disabled={isLastQuestion} variant="outline" size="sm" className="w-24 sm:w-32 h-10 sm:h-12 text-sm sm:text-base font-medium hover:scale-105 transition-transform duration-200 border-gray-600 text-gray-300 hover:bg-gray-700">
              Próxima
