          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1 flex-wrap">
                ...
                <Badge variant="outline" className="border-gray-600 text-gray-400 bg-gray-800/50 text-lg font-bold">
    ...
    <Card className="bg-netflix-card border-netflix-border p-6 max-w-4xl mx-auto shadow-xl">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1 flex-wrap">
              ...
              <Badge variant="outline" className="border-netflix-border text-gray-300 bg-netflix-card text-lg font-bold px-3 py-1">
                Questão {question.numero}
              </Badge>
            </div>
      ...
      <div className="space-y-3 mb-6 py-0 my-0 mx-0 px-0">
        {alternatives.map(alternative => (
          ...
          >
            <div className="flex items-start gap-3">
              <span className="font-bold text-lg min-w-[24px] flex-shrink-0 bg-black/20 rounded-full w-8 h-8 flex items-center justify-center">
                {alternative.key}
              </span>
              <span className="flex-1 text-sm sm:text-base whitespace-pre-wrap">
                {alternative.value}
      ...
      {!answered && (
        <Button
          ...
          className="w-full bg-netflix-red hover:bg-red-700 text-white py-3 text-lg font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 hover:scale-[1.02]"
        >
          Responder
        </Button>
      )}
      ...
      {showResult && question.justificativa && (
        <div className="mt-6 p-4 bg-netflix-card rounded-lg border border-netflix-border animate-fade-in">
          <h4 className="text-white font-semibold mb-2 flex items-center gap-2">
            <Scale size={16} className="text-netflix-red" />
