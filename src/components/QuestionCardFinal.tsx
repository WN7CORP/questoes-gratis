...
const QuestionCardFinal = ({
  ...
  return <>
      <Card className="bg-gray-900 border-gray-700 shadow-xl transition-all duration-200">
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 sm:gap-3 mb-1 flex-wrap">
                  ...
                  {showQuestionNumber && currentQuestion && totalQuestions && <Badge variant="outline" className="border-red-600 text-red-400 bg-red-900/30 text-xs font-medium px-2 py-1">
        ...
        {/* Question Content */}
        <div className="p-4 sm:p-6 bg-gray-900 px-[8px] py-[15px]">
          {/* Topic and Subject Info */}
          <div className="mb-4 sm:mb-6 bg-gray-800/60 border border-gray-700 rounded-lg p-3 sm:p-4 px-[11px] py-[8px]">
            ...
            {question.aplicada_em && <div className="pt-3 border-t border-gray-700 mt-3">
          ...
          {/* Submit Button */}
          {!answered && <Button onClick={handleSubmitAnswer} disabled={!selectedAnswer} className="w-full bg-red-600 hover:bg-red-700 text-white py-3 sm:py-4 text-base font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 hover:scale-[1.01] active:scale-[0.99] hover:shadow-lg">
              Confirmar Resposta
            </Button>}

          {/* Correct Answer Display */}
          {answered && <div className="mt-4 sm:mt-6 p-4 bg-gray-800/60 rounded-lg border border-gray-700">
              ...
              {question.alternativa_correta && <div className="text-gray-400 text-sm leading-relaxed pl-6">
