              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2 flex-wrap">
                  ...
                  {showQuestionNumber && currentQuestion && totalQuestions && (
                    <Badge variant="outline" className="border-blue-600 text-blue-400 bg-blue-900/20 text-sm font-bold px-3 py-1">
        ...
        <div className="p-6">
          ...
          <div className="space-y-4 mb-8">
            ...
            {alternatives.map((alternative, index) => (
              <button
                ...
                disabled={answered}
                className={`w-full p-5 rounded-xl border-2 text-left transition-all duration-300 hover:scale-[1.01] active:scale-[0.99] ${getAlternativeStyle(alternative.key)}`}
          ...
          {!answered && (
            <Button
              ...
              className="w-full bg-gradient-to-r from-netflix-red to-red-600 hover:from-red-600 hover:to-red-700 text-white py-4 text-lg font-bold disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] hover:shadow-xl shadow-lg"
            >
              Confirmar Resposta
            </Button>
          )}
          ...
          {answered && (
            <div className="mt-6 p-5 bg-gradient-to-r from-gray-800/60 to-gray-900/60 rounded-xl border border-gray-700/50 shadow-inner">
              ...
              {question.alternativa_correta && (
                <div className="text-gray-300 text-base leading-relaxed pl-8">
